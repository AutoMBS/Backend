"""
Medical Categories Rulebook Service
===================================

This module provides comprehensive access to medical categories data stored in
SQLite database. It handles all data retrieval, filtering, and statistical
operations for medical billing codes and service information.

Key Features:
- Medical categories data access and pagination
- Advanced filtering by age, time, and provider
- Statistical analysis and health monitoring
- Flexible query options with offset/limit support
- Comprehensive error handling and validation

Database Schema:
- Tables: category_1, category_3, etc.
- Fields: item_number, service_summary, start_age, end_age, etc.
- Relationships: Category-based organization of medical services
...
class RulebookService:
    """
    Service for managing medical categories data and rulebook operations.
    
    This service provides a comprehensive interface for accessing and manipulating
    medical categories data, including filtering, pagination, and statistical
    analysis capabilities.
    
    Key Features:
    - Medical categories data retrieval with pagination
    - Advanced filtering by medical criteria
    - Statistical analysis and reporting
    - Health monitoring and database connectivity checks
    - Flexible query options for different use cases
    
    Attributes:
        db_path (str): Path to the SQLite database file
        
    Example:
        service = RulebookService("../data/medical_categories.db")
    ...
    def __init__(self, db_path: str = "../data/medical_categories.db"):
        ...
        Note:
            The database should contain category tables (category_1, category_3, etc.)
            with medical service information.
        """
    ...
    def get_all_categories(self) -> List[Dict[str, Any]]:
        ...
        tables and provides summary information including record counts.
        
        Returns:
            List[Dict[str, Any]]: List of category information dictionaries
                                 Each dict contains: category_id, category_name, record_count
                                 
        Raises:
            HTTPException: If category retrieval fails
            
        Example:
            categories = service.get_all_categories()
            # Returns: [{"category_id": "1", "category_name": "category_1", "record_count": 667}, ...]
        """
        try:
            ...
            # Filter for category tables only, excluding system tables
            categories = []
            for table in tables:
                table_name = table[0]
                if (table_name.startswith('category_') and 
                    ...
                    # Get record count for each category
    ...
    def get_category_data(self, category_id: str, limit: Optional[int] = None, offset: int = 0) -> Dict[str, Any]:
    ...
    def filter_by_age_and_time(self, category_id: str, age: Optional[float] = None, 
                              time: Optional[float] = None, limit: Optional[int] = None, 
    ...
    def filter_category1(self, service_provider: Optional[str] = None, location: Optional[str] = None,
                        age: Optional[int] = None, time: Optional[int] = None,
                        restricted_gender: Optional[str] = None, limit: Optional[int] = None,
                        offset: int = 0) -> Dict[str, Any]:
    ...
    def filter_category3(self, provider: Optional[str] = None, treatment_location: Optional[str] = None,
                        therapy_type: Optional[str] = None, treatment_course: Optional[str] = None,
                        age: Optional[float] = None, duration: Optional[float] = None,
